...
module LicenseConcerns
  ...
  def sign_license(on_agree=:start_page_path, on_disagree='/logout', portal='CBRAIN') #:nodoc:
    @license = params[:license]

    unless params.has_key?(:agree) # no validation for info pages
      flash[:error] = "#{portal} cannot be used without signing the End User Licence Agreement."
